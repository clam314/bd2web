...
2026-07-06 追加:dating6 stage6 顺序互动二/三层链路已浏览器复核,例如
`6_5_0→6_21_0→6_22_0`,`6_7_0→6_23_0→6_24_0`,`6_4_0→6_25_0→6_26_0`,
`6_15_0→6_30_0→6_31_0→6_33_0` 均触发对应 `mix6_*` 动画历史。前端只新增
`PREFAB_ACTION_LABEL_OVERRIDES` 显示标签,不改 `data/dating_actions.json` 或播放状态机。
...
### 6.1 补第三层 mix/special 互动语音 —— ✅ 已完成(2026-07-03)
...
**2026-07-03 彻查+修复：全部 78 条都在各自本地 bank 且可播、零新 OGG,不需设备;
旧 A/B 分类作废,根因是三层基础问题(空 tsv 推断、大小写不匹配、17 号前缀别名)。
已修工具(apply 大小写规范、三工具 char-alias)并重跑 11 角色,全库残留归零,
核验与实测记录见 `DATING_PIPELINE.md` §7 TODO 6。**

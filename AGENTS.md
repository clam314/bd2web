...
**⚠️ 上面"Guest 无解"结论已被推翻(2026-07-01)**：dating15/16/17 = 温泉修行者·班塔纳(char067004)/
传奇退役·奥利维耶(char003604)/奇迹紫罗兰·帕莱特(char004202),**都在当前母包里**,Spine/热区/动作/情绪语音均已抽到。
之前当成 Refithea/Olivier/Palette 客串是旧标签误导。19 个角色的权威映射见 `data/dating_charid_map.json`。
心契点→语音母表现已 14 角色全量 `data/dating_interaction_tables.json`。
...
浏览器实测 dating19 各点出声、mix 未提取点正确静音。**残留 94 个是第三类(mix/special 互动语音未抽),需连 S25 补抽,详见
`DATING_PIPELINE.md` 第 7 节任务 6。**

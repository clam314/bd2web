...
浏览器实测 dating19 各点出声、mix 未提取点正确静音。**残留第三类(mix/special 互动语音未抽)现余 78 条缺失 voice 引用
(2026-07-03 复算;#16 的 16 条已本地清零,不用连设备——教训:先用总表 tsv 重解本地已有 bank 再下"要连设备"的结论;
旧"94"的分摊表 13/16 两项有误),详见 `DATING_PIPELINE.md` 第 7 节任务 6。**
